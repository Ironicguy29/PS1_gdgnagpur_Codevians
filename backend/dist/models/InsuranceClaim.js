...
const InsuranceClaimSchema = new mongoose_1.Schema({
    ...
    insurance_id: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Insurance', required: true },
...
InsuranceClaimSchema.pre('save', function () {
    return __awaiter(this, void 0, void 0, function* () {
        if (!this.claim_number) {
            ...
            let seq = 1;
            if (Counter) {
                const counter = yield Counter.findOneAndUpdate({ name: 'claim_number' }, { $inc: { seq: 1 } }, { new: true, upsert: true });
                seq = counter.seq;
            }
