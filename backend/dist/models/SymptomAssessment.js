...
const PotentialConditionSchema = new mongoose_1.Schema({
    condition: { type: String, required: true },
    probability: { type: Number, required: true },
    details: { type: String }
}, { _id: false });
const SymptomAssessmentSchema = new mongoose_1.Schema({
...
exports.default = mongoose_1.default.model('SymptomAssessment', SymptomAssessmentSchema);
