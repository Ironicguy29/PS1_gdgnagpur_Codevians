...
const LabOrderSchema = new mongoose_1.Schema({
    ...
    visit_id: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Visit', required: false },
...
LabOrderSchema.pre('save', function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!doc.lab_order_id) {
            ...
            const counter = yield Counter_1.default.findOneAndUpdate({ name: 'lab_order_id' }, { $inc: { seq: 1 } }, { new: true, upsert: true });
